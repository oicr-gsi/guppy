...
workflow guppy {
    ...
    parameter_meta {
        ...
        samples: "an array of pairs: barcode and sample name"
    }
    ...
    scatter (sample in samples) {
        ...
        String outputFileNamePrefix = sample.outputFileNamePrefix
...
task mergeFastq {
  ...
  output {
    File mergedfastq = "~{outputFileNamePrefix}.fastq.gz"
  }

  parameter_meta {
    inputPath: "The directory of the fastq files generated by guppy."
